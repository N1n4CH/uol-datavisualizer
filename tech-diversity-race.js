function TechDiversityRace() {
  ...
  this.setup = function() {
    ...
    // COMPLETED: Create a select DOM element.
    this.select = createSelect();

    // COMPLETED: Set select position.
    this.select.position(400, 500);

    // COMPLETED: Fill the options with all company names.
  ...
  this.draw = function() {
    ...
    // select item.
    // COMPLETED: Use select value instead of hard-coded company
